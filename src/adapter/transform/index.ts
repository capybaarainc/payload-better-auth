...
import type { ModelKey } from "../../generated-types.js";

// Simplified because we use identical field names
function getCollectionByModelKey(collections: any, model: string) {
  return null;
}
function getCollectionFieldNameByFieldKeyUntyped(collection: any, fieldKey: string) {
  return fieldKey;
}
function getFieldKeyByCollectionFieldName(collection: any, fieldName: string) {
  return fieldName;
}
...
export const createTransform = (
  ...
  function isPayloadRelationship(
    ...
    const collection = payload.collections[collectionSlug as any];
